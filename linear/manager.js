const {Auther, get, debug, flushDebugLog} = require('@friggframework/core');
...
//                 identifier
//             );
//             throw new Error('Multiple entities found with the same external ID: ' + identifier);
//         }
//     }
//
...
//                 throw new Error(`Multiple credentials found with same identifier: ${userDetails.identifier}`);
//             }
...
//                 throw new Error(`A credential already exists with this identifier: ${userDetails.identifier}`);
//             }
