...
- fix: Making an excuse to release so we test slack
  message [#46](https://github.com/friggframework/frigg/pull/46) ([@seanspeaks](https://github.com/seanspeaks))
- fix: Making an excuse to release so we test slack message ([@seanspeaks](https://github.com/seanspeaks))
- fix: updated clyde API test instead of manager related
  items [#45](https://github.com/friggframework/frigg/pull/45) ([@seanspeaks](https://github.com/seanspeaks))
- fix: updated clyde API test instead of manager related items ([@seanspeaks](https://github.com/seanspeaks))
- test: added api.test.js to
  Clyde [#44](https://github.com/friggframework/frigg/pull/44) ([@seanspeaks](https://github.com/seanspeaks))
